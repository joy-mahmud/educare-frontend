...
export default function StudentMarkSheet() {
  ...
  const [viewStudentMarksheet, setViewStudentMarksheet] = useState(false);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-100 text-xs md:text-sm">
              Marksheet generating system - Bangladesh National Curriculum
            </p>
          </div>
        </div>
        ...
        {viewStudentMarksheet ? (
          <SingleStudentMarksheet
            ...
            exam={selectedExam}
            setViewStudentMarksheet={setViewStudentMarksheet}
          />
        ) : (
          <>
            {/* Filter Section */}
